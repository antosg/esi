echo off
	echo Comienza la creacion de la app
		echo borrando las ultimas versines que se crearon
			del C:\Users\antos\Antonio\reponline\esi\platforms\android\app\build\outputs\apk\release\app-release-unsigned.apk
			del C:\Users\antos\Antonio\reponline\esi\platforms\android\app\build\outputs\apk\release\esi.apk
		...
		echo firmando la release
			cd C:\Users\antos\Antonio\reponline\esi\platforms\android\app\build\outputs\apk\release
